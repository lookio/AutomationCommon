...
//                        LPMobileLog.i(TAG, "line " + line);
	...
	public enum LogCatType {
		...
		CONCURRENCY_SANITY_VISITOR_LOCAL("adb -s 192.168.56.100:5555 shell logcat", "CONCURRENCY_SANITY_VISITOR"),
		CONCURRENCY_AGENT_RESOLVE_VISITOR_LOCAL("adb -s 192.168.56.101:5555 shell logcat", "CONCURRENCY_AGENT_RESOLVE_VISITOR"),


		CONCURRENCY_SANITY_VISITOR_CLEAN("adb -s emulator-5554 shell logcat -c", "CONCURRENCY_SANITY_VISITOR"),
		CONCURRENCY_AGENT_RESOLVE_VISITOR_CLEAN("adb -s emulator-5556 shell logcat -c", "CONCURRENCY_AGENT_RESOLVE_VISITOR"),

		CONCURRENCY_SANITY_VISITOR_CLEAN_LOCAL("adb -s 192.168.56.100:5555 shell logcat -c", "CONCURRENCY_SANITY_VISITOR"),
		CONCURRENCY_AGENT_RESOLVE_VISITOR_CLEAN_LOCAL("adb -s 192.168.56.102:5555 shell logcat -c", "CONCURRENCY_AGENT_RESOLVE_VISITOR");
