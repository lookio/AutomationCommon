...
//    static StringTokenizer startAppiumServerArgs = new StringTokenizer("/c,node.exe,node_modules\\appium\\bin\\appium.js,--address,127.0.0.1,--port,4723,--bootstrap-port,4724,--no-reset,--local-timezone,--log,appiumServerLogs.txt", ",");
    static String startAppiumServerOnWindowsArgs = "/c,node.exe,node_modules\\appium\\bin\\appium.js,--address,INPUT_IP,--port,INPUT_PORT, --log-level, info";//, --log-level, info";
    static String startAppiumServerOnMacArgs = "node_modules\\appium\\bin\\appium.js,--address,127.0.0.1,--port,4723,--launch-timeout,600000";
    static StringTokenizer stopAppiumServerArgs = new StringTokenizer("/c,taskkill,/F,/IM,node.exe", ",");
    static List<String> argsWithFalseFlag = Arrays.asList("127.0.0.1", "--port", "4723", "--bootstrap-port" , "4724");
